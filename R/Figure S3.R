...
rownames(RP)<-RP$V1
#use dynamic, partially dynamic, and strongly stable pathways generated in Fig. 3 code
dynx<-foreach(i=1:123,.combine='rbind') %do% { #123- number of pathways
  x<-dyn_paths[i,]
  x$Cluster<-i-1
...
#Repeat for partially dynamic and strongly stable pathways

#plotting
#make and read in a file with pathways for all 3 categories (Table S8d)
